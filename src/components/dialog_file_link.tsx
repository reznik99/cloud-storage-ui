...
function FileLinkDialog(props: IProps) {
    ...
    const loadLink = useCallback(async () => {
        try {
            ...
            const fileKey = props.file.wrapped_file_key ? await DecryptFileKey(props.file.wrapped_file_key) : '';
            const link: Link = {
    ...
    return (
        ...
        >
            ...
            <DialogContent>
                ...
                {!link && (
                    <Button sx={{ marginY: 3 }} startIcon={<Add />} onClick={createLink}>
                        Create link
                    </Button>
                )}
                ...
                <List>
                    {loading ? (
                        ...
                        <Alert severity="info">
                            <AlertTitle>
                                This file is <b>not</b> currently being shared.
                            </AlertTitle>
                        </Alert>
                    )}
                </List>
