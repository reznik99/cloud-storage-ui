...
function Settings() {
    ...
    return (
        <Container component={Paper} sx={{ paddingTop: '1em' }}>
            ...
            <Stack direction="column" spacing={1} padding="2em">
                <Stack direction="column" spacing={2}>
                    ...
                    <FormControl>
                        ...
                        <TextField fullWidth variant="standard" color="primary" value={user.emailAddress} disabled />
                    </FormControl>
                    <FormControl>
                        <Typography>Password</Typography>
                        <TextField fullWidth variant="standard" color="primary" value={'*'.repeat(15)} disabled />
                    </FormControl>
                ...
                <Grid container spacing={3}>
                    ...
                    <Grid size={{ lg: 'auto', sm: 12 }}>
                        <Button variant="outlined" onClick={editField} startIcon={<AccountCircle />}>
                            Update email address
                        </Button>
                    </Grid>
                    <Grid size={{ lg: 'auto', sm: 12 }}>
                        <Button variant="outlined" onClick={() => setDialogOpen('password')} startIcon={<Password />}>
                            Change password
                        </Button>
                    </Grid>
                    <Grid size={{ lg: 'auto', sm: 12 }}>
            ...
            <ChangePasswordDialog open={dialogOpen === 'password'} closeDialog={() => setDialogOpen('')} />

            <DeleteAccountDialog open={dialogOpen === 'delete_account'} closeDialog={() => setDialogOpen('')} />
        </Container>
    );
}
