            ...
            <Card sx={{ padding: 5, width: '50%' }}>
                ...
                >
                    ...
                    <Alert severity="warning">
                        ...
                        <Typography>
                            This action will change your Account and Master encryption keys. This means that all your
                            previously uploaded files will become unaccessible, and in turn will be deleted. This action
                            cannot be undone, and your files will not be recoverable.
                        </Typography>
                        <ul>
                            <li>
                            ...
                            <li>
                                All previously shared links will no longer work{' '}
